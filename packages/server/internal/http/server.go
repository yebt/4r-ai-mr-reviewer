...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("POST /providers/test", s.testProvider)
	...
	mux.HandleFunc("PUT /telegram/{id}", s.updateTelegram)
	mux.HandleFunc("POST /telegram/{id}/duplicate", s.duplicateTelegram)
	...
	mux.HandleFunc("POST /routines/{id}/unarchive", s.unarchiveRoutine)
